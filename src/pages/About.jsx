    ...
    <div className="bg-black text-white overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute top-32 left-20 w-72 h-72 rounded-full bg-indigo-500/10 blur-3xl"
        />
        <motion.div
          animate={{ y: [0, 40, 0] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-32 right-20 w-80 h-80 rounded-full bg-pink-500/10 blur-3xl"
        />
      ...
      <section className="py-32 px-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-white/70 max-w-3xl mb-10">
            I work across the full lifecycle of modern systems —
            from network foundations to data intelligence —
            with a unified mindset of reliability and scale.
          </p>
      ...
      <section className="py-32 bg-white/5 px-6">
        ...
        >
          ...
          <ul className="space-y-5 text-white/70">
            <li>• Calm during incidents, methodical during recovery</li>
            <li>• Structured debugging over guesswork</li>
            <li>• Documentation as a first-class citizen</li>
            <li>• Ownership beyond job descriptions</li>
      ...
      <section className="py-32 px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-white/70 max-w-3xl leading-relaxed">
            When I’m not building systems, you’ll find me cooking,
            singing, reflecting, and learning.
            Creativity and discipline shape both my work and life.
          </p>
        </motion.div>
      </section>
